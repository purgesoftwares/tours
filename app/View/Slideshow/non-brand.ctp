				...
				<?php /* if($gallery["Gallery"]['include_agent_title']){ ?>
					<ul class="pull-right nav" id="yw0">
						...
						<li class="dropdown">
							...
							<a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0); "><strong><?php echo !empty($gallery["Gallery"]['alt_agent_title'])?"Realtor: ".$gallery["Gallery"]['alt_agent_title']:"Realtor: ".$gallery["Shoot"]["Photographer"]['first_name'].$gallery["Shoot"]["Photographer"]['last_name'] ?></strong> <span class="caret"></span></a>
						<?php if($gallery["Gallery"]['include_agent_contact']){ ?>
						<ul id="yw1" class="dropdown-menu">
							<li>
								<a class="moreInfo" target="_blank" tabindex="-1" href="javascript:void(0);"><strong>Phone :</strong><?php echo !empty($gallery["Gallery"]['alt_agent_phone'])?$gallery["Gallery"]['alt_agent_phone']:$gallery["Shoot"]["Photographer"]['telephone'] ?></a>
							</li>
							
							<li class="divider"></li>
							<li>
								<a class="moreInfo" target="_blank" tabindex="-1" href="javascript:void(0);"><strong>Email :</strong><?php echo !empty($gallery["Gallery"]['alt_agent_email'])?$gallery["Gallery"]['alt_agent_email']:$gallery["Shoot"]["Photographer"]['email'] ?></a>
							</li>
					...
					<a href="<?php echo $this->html->url(array('plugin'=>false,'controller'=>'slideshow','action'=>'non-branded',base64_encode($id))); ?>#" style="float:left" class="social addthis_button_twitter">
					<i class="icon-twitter-sign icon-large"></i>
					</a>
					<a href="<?php echo $this->html->url(array('plugin'=>false,'controller'=>'slideshow','action'=>'non-branded',base64_encode($id))); ?>#" style="float:left" class="social addthis_button_pinterest_share">
					<i class="icon-pinterest-sign icon-large"></i>
					</a>
					<a href="<?php echo $this->html->url(array('plugin'=>false,'controller'=>'slideshow','action'=>'non-branded',base64_encode($id))); ?>#" style="float:left" class="social addthis_button_compact"><i class="icon-plus-sign icon-large"></i></a></div>
...
<div id="map_canvas" style=" height:500px;width:100%; border:1px solid #ccc"></div>
<script>
var geocoder;
var map;
var address = "<?php echo (empty(trim($complete_address)))?$sht_address:$complete_address; ?>";
