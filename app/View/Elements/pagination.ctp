...
<?php 
	echo $paginator->first(__('First', true), array('id'=> 'p_first','tag'=>'span'), null, array('class'=>''));
	echo $paginator->prev(__("&larr; Previous", true), array('id'=> 'p_prev','tag'=>'span','escape'=>false), null, array('class'=>'previous p_numbers','escape'=>false));
	echo $paginator->numbers($options,array('tag'=>'li'));
	echo $paginator->next(__("Next &rarr;", true), array('id'=> 'p_next','tag'=>'span','escape'=>false), null, array('class'=>'current','escape'=>false));
	echo $paginator->last(__('Last', true), array('id'=> 'p_last','tag'=>'span'), null, array('class'=>''));
?></ul>
</div>
<?php 
}
