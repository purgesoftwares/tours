									...
									<div class="span12" >
									  ...
									  <div class="control-group <?php echo ($this->Form->error($model.".alt_agent_phone"))? "error":"";?>">
									   ...
									   <div class="form-actions">
										...
										<?php echo $this->html->link(__("Copy Tour URL", true),array("class"=>"btn btn-primary",'disabled'=>'disabled','id'=>'copy_tour_url')); ?>&nbsp; <i class="icon-info-sign" id="popoverData" href="#" data-content='You must click on "Create Virtual Tour" at least once to make URL available. Click again to save any changes.' rel="popover" data-placement="bottom" data-trigger="hover" ></i>
	...
	$(document).ready(function(){
		...
		$("#create_virtual_tour").on('click',function(){
			...
			$.ajax({
				...
				success : function(r){
					alert(r.message);
					$("#copy_tour_url").removeAttr("disable");
					$("#copy_tour_url").on('click',function(){
						 window.prompt("Copy to clipboard: Ctrl+C, Enter", "sdsdfds");
					});
				}
				});
