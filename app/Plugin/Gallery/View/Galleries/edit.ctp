...
<div class="span12" >
         ...
         <div class="control-group <?php echo ($this->Form->error($model.".name"))? "error":"";?>">
           <?php echo $this->Form->label($model.".name", __('Product Name').": *",array("class"=>"control-label")); ?>
            <div class="controls">
          ...
          <div class="control-group <?php echo ($this->Form->error($model.".price"))? "error":"";?>">
           <?php echo $this->Form->label($model.".price", __('Product Price').": *",array("class"=>"control-label")); ?>
            <div class="controls">
		  ...
		  <div class="control-group <?php echo ($this->Form->error($model.".description"))? "error":"";?>">
           <?php echo $this->Form->label($model.".description", __('Product Description').": *",array("class"=>"control-label")); ?>
            <div class="controls">
           ...
           <?php echo $this->Form->label($model.".taxable", __('Taxable Product?').": ",array("class"=>"control-label")); ?>
            <div class="controls">
