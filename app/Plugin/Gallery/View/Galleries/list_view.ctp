							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin table-bordered">
									...
									if( !empty($result) ) {
										...
										$color = "#fff";
										$trdata = "";
										if(isset($records['Invoice']['status']) && !$records['Invoice']['status']){
											$color = "#999";
											$trdata = 'data-container="body" data-trigger="hover" data-placement="bottom"  data-toggle="popover" data-content="Not able to download? Please make sure your invoice for this shoot has been paid." ';
										}
										?>
										<tr <?php echo $trdata; ?>>
											<td style= 'background-color:<?php echo $color ?>; '><?php echo $records[$model]['gallery_title'];?></td>
											<td style= 'background-color:<?php echo $color ?>; ' class='hidden-1024'><?php echo date("m/d/Y",$records[$model]['created']);  ?></td>
											<td  style= 'background-color:<?php echo $color ?>; 'class=''>
