      ...
      <th  style="background-color: #EEEEEE;"> <div class="row-fluid">
          <h1>
            ...
            <div class="pull-right">
              <?php
				echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i> ".__('Back To Photographers'),array("action"=> "index"),array("class"=>"btn btn-primary","escape"=>false));
				?>
            </div>
          </h1>
        </div>
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".price"))? "error":"";?>"> 
						<?php echo $this->Form->label($model.".price", __('Payment')."(%): *",array("class"=>"control-label")); ?>
						<div class="controls"> <?php echo $this->Form->text($model.".price",array('class'=>'',"data-rule-required"=>true,"data-rule-number"=>true)); ?>
						<span class="help-inline">
