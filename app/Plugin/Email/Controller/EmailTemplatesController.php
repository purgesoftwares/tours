 ...
 */
	...
	public function constants() {	
		...
		}else if($constant_name == 'campaign_activated'){
			$Email_constant	= 	Configure::read('campaign_activated');
			
		}else if($constant_name == 'resource_sale_confirmation_user'){
			$Email_constant	= 	Configure::read('resource_sale_confirmation_user');
			
		}else if($constant_name == 'resource_sale_confirmation_partner'){
			$Email_constant	= 	Configure::read('resource_sale_confirmation_partner');
			
		}else if($constant_name == 'partner_subscribe_confirmation'){
			$Email_constant	= 	Configure::read('partner_subscribe_confirmation');
			
		}else if($constant_name == 'partner_upgrade_confirmation'){
			$Email_constant	= 	Configure::read('partner_upgrade_confirmation');
			
		}else if($constant_name == 'partner_upgradeaddresource_confirmation'){
			$Email_constant	= 	Configure::read('partner_upgradeaddresource_confirmation');
