...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\" style=\"font-family:Arial, Helvetica, sans-serif\">\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\" style=\"font-family:Arial, Helvetica, sans-serif\">\n";
   ...
   function validate_ipn() {
      ...
      $fp = fsockopen('ssl://'.$url_parsed['host'],"443",$err_num,$err_str,30); //sandbox
