...
class AppController extends Controller {
	...
	*/
	...
	public function beforeFilter() {
		...
		$scope = array('User.active' => 1,'User.user_role_id' => array(Configure::read('user_roles.admin')));
		...
		$this->Auth->allow('login','send_invoice_reminder','_sendMail','language');
		
		
		/* -----Menu auth check- start here---------- */
		$admin_data	=	$this->Session->read('Auth.Admin');
