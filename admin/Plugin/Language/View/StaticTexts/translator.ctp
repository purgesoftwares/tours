		...
		<div class="row-fluid">
		   <h1><?php echo $humanize;?>
			   <div class="pull-right">
			    <?php
					//echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i> Back To Sites",array('plugin'=>'setting','controller'=>'settings',"action"=> "index"),array("class"=>"btn btn-primary","escape"=>false));
					?>
			  </div>
		   </h1>
		</div>
			...
			<tr style="height:30px;">
              ...
              <tr style="height:30px;" class="gallerytr">
				...
				<td width="15%" align="center">
					...
					<!--edit action-->
					  <?php 
					//echo $this->Html->link('<i class="icon-pencil icon-white"></i> Edit', array('action' => 'edit',$records[$model]['id']), array('class' => 'btn btn-primary', 'escape' => false) )." ";
					echo $this->Html->link('<i class="icon-pencil icon-white"></i> Edit Expressions', array('action' => 'edit_expressions',$records[$model]['site_id'],$records[$model]['id']), array('class' => 'btn btn-primary', 'escape' => false) )." ";
