 ...
 */	
	...
	function delete($id=null) {
		if($id==null){
			...
			$this->Session->setFlash('Video Tutorial has been deleted.','success');
	...
	function set_default($id = null) {
		...
		if ($this->{$this->modelClass}->save($data,false)) {
			...
			$this->Session->setFlash($data[$this->modelClass]['title'].' has been set as default video tutorial.', 'success');
			$this->redirect(array('action' => 'index'));
		}
		exit;
	}
