					...
					<div class="span12">
						...
						<div class="box box-color box-bordered"   style="border-top: #368ee0 solid 2px;" >
							...
							<div class="box-content nopadding">
								...
								<h4>
									Generate Payment Report according the range
								</h4>
							...
							<div class="pull-right">
										<?php echo $this->Form->create('Transaction',array('url'=>array('controller'=>'reports','action'=> 'export_transaction_report'))); ?>
								...
								<table class="table table-hover table-nomargin dataTable table-bordered">
									<thead>
										<tr class='thefilter'>
											...
											<th><?php echo __('Invoice Title'); ?></th>
									...
									if( !empty($results) ) {
										...
										?>
										<tr>
											<td><?php echo $records["Transaction"]['payment_date'];?></td>
											<td><?php echo $records["Invoice"]["Client"]['first_name'].' '.$records["Invoice"]["Client"]['last_name'];?></td>
											<td><?php echo $records["Invoice"]['title'];?></td>
											<td><?php echo $records["Invoice"]['payment'];?></td>
											<td><?php echo $records["Invoice"]['tax'];?></td>
											<td><?php echo $records["Invoice"]['total'];?></td>
											<td><?php echo $records["Transaction"]['method'];?></td>
