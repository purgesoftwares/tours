...
<script>
						...
						/* eventAfterRender: function(event, element) {
													...
													events: [ // put the array in the `events` property
														<?php  if(!empty($result)){
															foreach($result as $event){ ?>
															{
																...
																start  : '<?php echo date('Y-m-d',strtotime($event[$model]['date'])); ?>'
							...
							$("#ShootProductId").on('change',function(){
								$("#ShootPrice").val(product_price_list[$(this).val()]);
							...
							$("#ShootPhotographerId,#ShootProductId").on('change',function(){
								$("#ShootPayment").val(((photographer_price_list[$("#ShootPhotographerId").val()]/100)*$("#ShootPrice").val()).toFixed(2));
							});
							...
							$("#ShootDate,#ShootTimeHour,#ShootTimeMin,#ShootTimeMeridian,#ShootAddress1").on('change',function(){
...
<div class="row-fluid" >
				<div class="span12">
	<!-- Modal -->
<div class="" id="add_new_shoot_model" >
  <div >
  <?php 
  $model = "Shoot";
    ...
    <div >
      ...
      <div >
				...
				<div class="span5" style="margin-left:20px;" >
					...
					echo ($this->Form->error($model.".show_on_calender"))? "error":"";?>"> 
						<?php echo $this->Form->label($model.".show_on_calender", __('Show On Calender?').": ",array("class"=>"control-label")); ?>
						<div class="controls"> <?php echo $this->Form->checkbox($model.".show_on_calender",array('value'=>1,'checked'=>'checked')); ?>
						<span class="help-inline">
						<?php echo $this->Form->error($model.".show_on_calender",array("wrap"=>false)); ?>
						</span> 
						</div>
					</div>
				</div>
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".size"))? "error":"";?>"> 
						<?php echo $this->Form->label($model.".size", __('Size of Shoot').": ",array("class"=>"control-label")); ?>
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".product_id"))? "error":"";?>"> 
						<?php echo $this->Form->label($model.".product_id", __('Product').": ",array("class"=>"control-label")); ?>
						<div class="controls"> <?php echo $this->Form->select($model.".product_id",$product_list,array('empty'=>false,"data-rule-required"=>true)); ?>
						<span class="help-inline">
						<?php echo $this->Form->error($model.".product_id",array("wrap"=>false)); ?>
						</span> 
						</div>
					</div>
				</div>
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".global_comment"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->textarea($model.".global_comment"); ?>
						<span class="help-inline">
     ...
     <div class="row-fluid">
				<br/>
				<div class="span5" style="margin-left:140px;" >
...
<script>
	...
	$(document).ready(function(){
		...
		$(".close,.close_button").on('click',function(){
			...
			if (r == true) {
				window.location = '<?php echo $this->Html->url(array('action'=>'index',$client_id)); ?>';
