					...
					<div class="span12">
						...
						<div class="box box-color box-bordered"   style="border-top: #368ee0 solid 2px;" >
							...
							<div class="box-content nopadding">
								...
								<h4>
									Generate Sales Report according the range
								</h4>
								...
								<div style="" class="span4" >
									<div class="control-group <?php echo ($this->Form->error($model.".range"))? "error":"";?>"  > 
										...
										<div class="controls">
											<?php echo $this->Form->select("range", array("Month","Quarter","Year","Last 12 Months","All Time"),array('empty'=>false)); ?>
										</div>
									</div>
									</div>
									<div class="span4" >
							...
							<div class="pull-right">
										<?php echo $this->Form->create('Transaction',array('url'=>array('controller'=>'reports','action'=> 'export_sales_report_report'))); ?>
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin  table-bordered table-nosorting">
									<thead>
										<tr class='thefilter'>
									...
									if( !empty($results) ) {
										...
										<tr>
											...
											<td><?php echo (isset($result[0][0]['total_paid']) && !empty($result[0][0]['total_paid']))?$result[0][0]['total_paid']:0; ?></td>
				...
				var data = [];
							<?php $i = 0;
									if( !empty($results) ) {
										...
										?>
										data.push([<?php echo $i; ?>, <?php echo (isset($result[0][0]['total_paid']) && !empty($result[0][0]['total_paid']))?$result[0][0]['total_paid']:0; ?>]);
