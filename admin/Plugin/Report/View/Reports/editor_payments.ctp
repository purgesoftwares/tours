					...
					<div class="span12">
						...
						<div class="box box-color box-bordered"   style="border-top: #368ee0 solid 2px;" >
							...
							<div class="box-content nopadding">
								...
								<h4>
									Generate Editor Payments Report according the range
								</h4>
							...
							<div class="pull-right">
										<?php echo $this->Form->create('Transaction',array('url'=>array('controller'=>'reports','action'=> 'export_editor_payments_report'))); ?>
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin  table-bordered table-nosorting">
									...
									if( !empty($results) ) {
										...
										?>
										<tr>
											<td><?php echo $records["Shoot"]['date'];?></td>
											<td><?php echo $records["Shoot"]['title'];?></td>
											<td><?php echo $records["Shoot"]['editing_time'];?></td>
				...
				var data = [];
							<?php $i = 0;
									if( !empty($results) ) {
										...
										if( !empty($result) ) {
										foreach( $result as $records ) { 
											$total += $records["Shoot"]['editing_time'];
											// pr($records); die;
										}
