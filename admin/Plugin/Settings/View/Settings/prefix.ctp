			...
			<div class="control-group <?php echo ($this->Form->error("Setting.$i.value"))? 'error':'';?>">
				...
				<div class="controls">
					<?php if($key=='Site.default_image' && $setting['Setting']['value']!=''){
						...
						echo $this->Html->link($this->Html->image('cross.png',array('title'=>'Delete','alt' => 'delete')),array('action'=>'delete_image',$setting['Setting']['value']),array('escape'=>false),__("Are you sure you wish to delete this image?"));
