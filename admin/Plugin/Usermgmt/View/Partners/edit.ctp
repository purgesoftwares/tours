...
<table class="table table-bordered table-striped">
  <thead>
    ...
    <tr>
      <td>
		<?php 
		echo $this->Form->create($model, array('url' => array('plugin' => 'usermgmt','controller' => 'partners', 'action' => 'edit'),"class"=>"form-horizontal form-validate",'type' => 'file'));
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".email"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->text($model.".email",array('class'=>'validate[required,custom[email]]',"data-rule-required"=>true)); ?>
						<span class="help-inline">
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".lat_long"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->text($model.".lat_long",array('class'=>'validate[required]',"data-rule-required"=>true)); ?>
						<span class="help-inline">
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".nif"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->text($model.".nif",array('class'=>'validate[required,custom[number],funcCall[validateNif]]')); ?>
							<span class="help-inline">
