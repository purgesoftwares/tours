<table class="table table-bordered table-striped">
  <thead>
    ...
    <tr>
      <td>
		<?php 
		echo $this->Form->create($model, array('url' => array('plugin' => 'usermgmt','controller' => 'customers', 'action' => 'change_password'),"class"=>"form-horizontal form-validate",'type' => 'file'));
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".password"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->password($model.".password",array('class'=>'',"data-rule-required"=>true)); ?>
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".cpassword"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->password($model.".cpassword",array('class'=>'',"data-rule-required"=>true,"data-rule-equalto"=>"#CustomerPassword")); ?>
							<span class="help-inline">
