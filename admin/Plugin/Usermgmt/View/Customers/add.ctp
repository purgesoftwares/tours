...
<table class="table table-bordered table-striped">
  <thead>
    ...
    <tr>
      ...
      <td><?php echo $this->Form->create($model,array("class"=>"form-horizontal form-validate",'novalidate'=>'novalidate','type'=>'file')); ?>
        <div class="row-fluid">
          <div class="span12" >
          </div>
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".first_name"))? "error":"";?>"> 
						...
						<div class="controls"> 
						<?php echo $this->Form->text($model.".first_name",array('class'=>'',"data-rule-required"=>true,'id'=>'first_name')); ?>
						<span class="help-inline" for="first_name" >
				...
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".last_name"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->text($model.".last_name",array('class'=>'validate[required]',"data-rule-required"=>true)); ?>
			...
			<div class="row-fluid">
				...
				<div class="span5" >
					...
					<div class="controls">  <?php echo $this->Form->text($model.".dob",array('readonly'=>'readonly','class'=>'validate[required] datepick',"data-rule-required"=>true)); ?><span class="help-inline"><?php echo $this->Form->error($model.".dob",array("wrap"=>false)); ?></span> </div>
					</div>
				</div>
			</div>
			<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".cpassword"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->password($model.".cpassword",array('class'=>'validate[required,equals[CustomerPassword]]',"data-rule-required"=>true,"data-rule-equalto"=>"#CustomerPassword")); ?>
							<span class="help-inline">
			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".country"))? "error":"";?>"> 
						...
						echo $this->Form->select($model.".country",$countries,array('class'=>'','empty'=>false,'value'=>'Portugal','id'=>'country_id'));?>
						<span class="help-inline">
			...
			<div class="row-fluid">
				...
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".nif"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->text($model.".nif",array('class'=>'validate[required,custom[number],funcCall[validateNif]]',"data-rule-required"=>true,"data-rule-validnif"=>true)); ?>
							<span class="help-inline">
