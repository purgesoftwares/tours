	...
	if( !empty($result) ) {
		...
		<tr class="gallerytr">
			...
			<td  align="left">
				...
				<?php echo $this->Html->link('<i class="icon-user"></i>',array('action'=>'profile',$records[$model]['id']),array('class'=>"btn","rel"=>"tooltip","data-placement"=>"top","title"=>"Profile",'escape'=>false)).'&nbsp;'; ?>
				<?php echo $this->Html->link('<i class="icon-pencil"></i>',array('action'=>'change_password',$records[$model]['id']),array('class'=>"btn","rel"=>"tooltip","data-placement"=>"top","title"=>"Change Password",'escape'=>false)); ?>
				<a href='javascript::void(0)' onclick='return delete_user("<?php echo __('Are you sure you want to delete this client?'); ?>",this);' id='delete_<?php echo $records[$model]['id']; ?>' class='btn' rel="tooltip" data-placement="top" title="<?php echo __('Delete'); ?>"><i class="icon-remove"></i></a>
			</td>
		</tr>
      <?php
			$i++;
