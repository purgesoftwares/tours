			...
			<div class="row-fluid">
				<div class="span5" >
					<div class="control-group <?php echo ($this->Form->error($model.".cpassword"))? "error":"";?>"> 
						...
						<div class="controls"> <?php echo $this->Form->password($model.".cpassword",array('class'=>'validate[required,equals[ClientPassword]]',"data-rule-required"=>true,"data-rule-equalto"=>"#ClientPassword")); ?>
							<span class="help-inline">
